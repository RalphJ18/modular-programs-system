...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['user_id'])) {
    ...
    $new_pass = password_hash("123", PASSWORD_DEFAULT);
...
<head>
    <meta charset="UTF-8">
    <title>Reset Password - Computer Shop System</title>
